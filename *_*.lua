...
local Library do 
    ...
    Components.Label = function(Data)
        local Items = { } do 
            ...
            if Data.Tooltip then 
                Items["Label"]:Tooltip(Data.Tooltip)
            end
    ...
    Library.Window = function(self, Data)
        ...
        local Window = {
            ...
            Size = Data.Size or Data.size or UDim2New(0, 563, 0, 500),
        ...
        local Items = Components.Window({
            ...
            Draggable = true,
            Resizable = true,
            ResizableX = 563, -- Window.Size.X.Offset
            ResizableY = 500 -- Window.Size.Y.Offset
        }) do 
            Items["Title"] = Instances:Create("Frame", {
                Parent = Items["Inline"].Instance,
                Name = "\0",
    ...
    Library.Sections.Dropdown = function(self, Data)
        ...
        local Dropdown = {
            ...
            Multi = Data.Multi or Data.PenetrationCost or false,
        }
    ...
    Library.Sections.Label = function(self, Data)
        ...
        local Label = {
            ...
            Name = Data.Text or "Label",
            Alignment = Data.Alignment or "Left",
